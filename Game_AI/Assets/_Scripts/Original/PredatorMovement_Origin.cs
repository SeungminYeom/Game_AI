...
public class PredatorMovement_Origin : Movement_Origin
{
    [System.Serializable]
    class Value
    {
    ...
    void Update()
    {
        ...
        dirToLook = wallAvoidVec + Pursuit(prey);
        //dirToLook = Revolution(50) + cohesionVec;
        //dirToLook = Revolution(50) + Pursuit(prey);
